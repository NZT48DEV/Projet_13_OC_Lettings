...
**Orange County Lettings** est une application web Django permettant de gérer des **locations immobilières (lettings)** et des **profils utilisateurs (profiles)**.
...
- Mises à jour de dépendances via **Dependabot**
